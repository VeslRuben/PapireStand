...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        list.add(new Book("Sex på stallen", "råger", "porno", "Frank", "01.05.1985", "1", 2, 1));
        ...
        list.add(new Book("Hvordan få orgasme", "inn", "porno", "Frank", "11.12.2003", "1", 2, 3));
        list.add(new Book("Blowjob på kjøpesenter", "finn", "porno", "Frank", "01.05.1985", "1", 2, 5));
        list.add(new Book("single søte jenter", "finn", "porno", "Frank", "01.05.1985", "1", 2, 7));
